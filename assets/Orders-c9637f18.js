...
`;function va({columns:e=[],conditionalRowStyles:t=[],defaultExpanded:n=!1,defaultExpanderDisabled:r=!1,dense:o=!1,expandableIcon:a,expandableRows:i=!1,expandableRowsComponent:l,expandableRowsComponentProps:d,expandableRowsHideExpander:m,expandOnRowClicked:p=!1,expandOnRowDoubleClicked:f=!1,highlightOnHover:x=!1,id:b,expandableInheritConditionalStyles:y,keyField:E,onRowClicked:$=N,onRowDoubleClicked:R=N,onRowMouseEnter:g=N,onRowMouseLeave:u=N,onRowExpandToggled:S=N,onSelectedRow:w=N,pointerOnHover:O=!1,row:h,rowCount:A,rowIndex:U,selectableRowDisabled:M=null,selectableRows:Z=!1,selectableRowsComponent:ae,selectableRowsComponentProps:T,selectableRowsHighlight:he=!1,selectableRowsSingle:Ce=!1,selected:se,striped:G=!1,draggingColumnId:me,onDragStart:de,onDragOver:J,onDragEnd:Ae,onDragEnter:q,onDragLeave:ue}){const[Y,pe]=s.useState(n);s.useEffect(()=>{pe(n)},[n]);const K=s.useCallback(()=>{pe(!Y),S(!Y,h)},[Y,S,h]),te=O||i&&(p||f),Se=s.useCallback(H=>{H.target&&H.target.getAttribute("data-tag")==="allowRowEvents"&&($(h,H),!r&&i&&p&&K())},[r,p,i,K,$,h]),ge=s.useCallback(H=>{H.target&&H.target.getAttribute("data-tag")==="allowRowEvents"&&(R(h,H),!r&&i&&f&&K())},[r,f,i,K,R,h]),X=s.useCallback(H=>{g(h,H)},[g,h]),be=s.useCallback(H=>{u(h,H)},[u,h]),Re=ze(h,E),{style:Xe,classNames:et}=or(h,t,["rdt_TableRow"]),Ct=he&&se,St=y?Xe:{},Rt=G&&U%2==0;return s.createElement(s.Fragment,null,s.createElement(xa,{id:`row-${b}`,role:"row",striped:Rt,highlightOnHover:x,pointerOnHover:!r&&te,dense:o,onClick:Se,onDoubleClick:ge,onMouseEnter:X,onMouseLeave:be,className:et,selected:Ct,style:Xe},Z&&s.createElement(ua,{name:`select-row-${Re}`,keyField:E,row:h,rowCount:A,selected:se,selectableRowsComponent:ae,selectableRowsComponentProps:T,selectableRowDisabled:M,selectableRowsSingle:Ce,onSelectedRow:w}),i&&!m&&s.createElement(ha,{id:Re,expandableIcon:a,expanded:Y,row:h,onToggled:K,disabled:r}),e.map(H=>H.omit?null:s.createElement(ca,{id:`cell-${H.id}-${Re}`,key:`cell-${H.id}-${Re}`,dataTag:H.ignoreRowClick||H.button?null:"allowRowEvents",column:H,row:h,rowIndex:U,isDragging:Qe(me,H.id),onDragStart:de,onDragOver:J,onDragEnd:Ae,onDragEnter:q,onDragLeave:ue}))),i&&Y&&s.createElement(ba,{key:`expander-${Re}`,data:h,extendedRowStyle:St,extendedClassNames:et,ExpanderComponent:l,expanderComponentProps:d}))}const Ca=D.span`
	padding: 2px;
	color: inherit;
	flex-grow: 0;
	flex-shrink: 0;
...
`,Oa=D.div`
	...
	white-space: nowrap;
	text-overflow: ellipsis;
`;var ka=s.memo(function({column:e,disabled:t,draggingColumnId:n,selectedColumn:r={},sortDirection:o,sortIcon:a,sortServer:i,pagination:l,paginationServer:d,persistSelectedOnSort:m,selectableRowsVisibleOnly:p,onSort:f,onDragStart:x,onDragOver:b,onDragEnd:y,onDragEnter:E,onDragLeave:$}){s.useEffect(()=>{typeof e.selector=="string"&&console.error(`Warning: ${e.selector} is a string based column selector which has been deprecated as of v7 and will be removed in v8. Instead, use a selector function e.g. row => row[field]...`)},[]);const[R,g]=s.useState(!1),u=s.useRef(null);if(s.useEffect(()=>{u.current&&g(u.current.scrollWidth>u.current.clientWidth)},[R]),e.omit)return null;const S=()=>{if(!e.sortable&&!e.selector)return;let T=o;Qe(r.id,e.id)&&(T=o===ve.ASC?ve.DESC:ve.ASC),f({type:"SORT_CHANGE",sortDirection:T,selectedColumn:e,clearSelectedOnSort:l&&d&&!m||i||p})},w=T=>s.createElement(Sa,{sortActive:T,sortDirection:o}),O=()=>s.createElement("span",{className:[o,"__rdt_custom_sort_icon__"].join(" ")},a),h=!(!e.sortable||!Qe(r.id,e.id)),A=!e.sortable||t,U=e.sortable&&!a&&!e.right,M=e.sortable&&!a&&e.right,Z=e.sortable&&a&&!e.right,ae=e.sortable&&a&&e.right;return s.createElement(Ra,{"data-column-id":e.id,className:"rdt_TableCol",headCell:!0,allowOverflow:e.allowOverflow,button:e.button,compact:e.compact,grow:e.grow,hide:e.hide,maxWidth:e.maxWidth,minWidth:e.minWidth,right:e.right,center:e.center,width:e.width,draggable:e.reorder,isDragging:Qe(e.id,n),onDragStart:x,onDragOver:b,onDragEnd:y,onDragEnter:E,onDragLeave:$},e.name&&s.createElement($a,{"data-column-id":e.id,"data-sort-id":e.id,role:"columnheader",tabIndex:0,className:"rdt_TableCol_Sortable",onClick:A?void 0:S,onKeyPress:A?void 0:T=>{T.key==="Enter"&&S()},sortActive:!A&&h,disabled:A},!A&&ae&&O(),!A&&M&&w(h),typeof e.name=="string"?s.createElement(Oa,{title:R?e.name:void 0,ref:u,"data-column-id":e.id},e.name):e.name,!A&&Z&&O(),!A&&U&&w(h)))});const Pa=D(Ge)`
	flex: 0 0 48px;
	justify-content: center;
	align-items: center;
	user-select: none;
	white-space: nowrap;
	font-size: unset;
`;function Da({headCell:e=!0,rowData:t,keyField:n,allSelected:r,mergeSelections:o,selectedRows:a,selectableRowsComponent:i,selectableRowsComponentProps:l,selectableRowDisabled:d,onSelectAllRows:m}){const p=a.length>0&&!r,f=d?t.filter(y=>!d(y)):t,x=f.length===0,b=Math.min(t.length,f.length);return s.createElement(Pa,{className:"rdt_TableCol",headCell:e,noPadding:!0},s.createElement(ir,{name:"select-all-rows",component:i,componentOptions:l,onClick:()=>{m({type:"SELECT_ALL_ROWS",rows:f,rowCount:b,mergeSelections:o,keyField:n})},checked:r,indeterminate:p,disabled:x}))}function lr(e=mt.AUTO){const t=typeof window=="object",[n,r]=s.useState(!1);return s.useEffect(()=>{if(t)if(e!=="auto")r(e==="rtl");else{const o=!(!window.document||!window.document.createElement),a=document.getElementsByTagName("BODY")[0],i=document.getElementsByTagName("HTML")[0],l=a.dir==="rtl"||i.dir==="rtl";r(o&&l)}},[e,t]),n}const Ia=D.div`
	display: flex;
	align-items: center;
	flex: 1 0 auto;
	height: 100%;
...
`;function ja({contextMessage:e,contextActions:t,contextComponent:n,selectedCount:r,direction:o}){const a=lr(o),i=r>0;return n?s.createElement(jn,{visible:i},s.cloneElement(n,{selectedCount:r})):s.createElement(jn,{visible:i,rtl:a},s.createElement(Ia,null,((l,d,m)=>{if(d===0)return null;const p=d===1?l.singular:l.plural;return m?`${d} ${l.message||""} ${p}`:`${d} ${p} ${l.message||""}`})(e,r,a)),s.createElement(Aa,null,t))}const _a=D.div`
	position: relative;
	box-sizing: border-box;
	overflow: hidden;
	display: flex;
...
`,es=D(dr)`
	margin: 0 4px;
`;var ts=s.memo(function({rowsPerPage:e,rowCount:t,currentPage:n,direction:r=c.direction,paginationRowsPerPageOptions:o=c.paginationRowsPerPageOptions,paginationIconLastPage:a=c.paginationIconLastPage,paginationIconFirstPage:i=c.paginationIconFirstPage,paginationIconNext:l=c.paginationIconNext,paginationIconPrevious:d=c.paginationIconPrevious,paginationComponentOptions:m=c.paginationComponentOptions,onChangeRowsPerPage:p=c.onChangeRowsPerPage,onChangePage:f=c.onChangePage}){const x=(()=>{const T=typeof window=="object";function he(){return{width:T?window.innerWidth:void 0,height:T?window.innerHeight:void 0}}const[Ce,se]=s.useState(he);return s.useEffect(()=>{if(!T)return()=>null;function G(){se(he())}return window.addEventListener("resize",G),()=>window.removeEventListener("resize",G)},[]),Ce})(),b=lr(r),y=x.width&&x.width>599,E=Ke(t,e),$=n*e,R=$-e+1,g=n===1,u=n===E,S=Object.assign(Object.assign({},Qa),m),w=n===E?`${R}-${t} ${S.rangeSeparatorText} ${t}`:`${R}-${$} ${S.rangeSeparatorText} ${t}`,O=s.useCallback(()=>f(n-1),[n,f]),h=s.useCallback(()=>f(n+1),[n,f]),A=s.useCallback(()=>f(1),[f]),U=s.useCallback(()=>f(Ke(t,e)),[f,t,e]),M=s.useCallback(T=>p(Number(T.target.value),n),[n,p]),Z=o.map(T=>s.createElement("option",{key:T,value:T},T));S.selectAllRowsItem&&Z.push(s.createElement("option",{key:-1,value:t},S.selectAllRowsItemText));const ae=s.createElement(Ka,{onChange:M,defaultValue:e,"aria-label":S.rowsPerPageText},Z);return s.createElement(Za,{className:"rdt_Pagination"},!S.noRowsPerPage&&y&&s.createElement(s.Fragment,null,s.createElement(es,null,S.rowsPerPageText),ae),y&&s.createElement(Xa,null,w),s.createElement(Ja,null,s.createElement(st,{id:"pagination-first-page",type:"button","aria-label":"First Page","aria-disabled":g,onClick:A,disabled:g,isRTL:b},i),s.createElement(st,{id:"pagination-previous-page",type:"button","aria-label":"Previous Page","aria-disabled":g,onClick:O,disabled:g,isRTL:b},d),!y&&ae,s.createElement(st,{id:"pagination-next-page",type:"button","aria-label":"Next Page","aria-disabled":u,onClick:h,disabled:u,isRTL:b},l),s.createElement(st,{id:"pagination-last-page",type:"button","aria-label":"Last Page","aria-disabled":u,onClick:U,disabled:u,isRTL:b},a)))});const $e=(e,t)=>{const n=s.useRef(!0);s.useEffect(()=>{n.current?n.current=!1:e()},t)};var ns=function(e){return function(t){return!!t&&typeof t=="object"}(e)&&!function(t){var n=Object.prototype.toString.call(t);return n==="[object RegExp]"||n==="[object Date]"||function(r){return r.$$typeof===rs}(t)}(e)},rs=typeof Symbol=="function"&&Symbol.for?Symbol.for("react.element"):60103;function Je(e,t){return t.clone!==!1&&t.isMergeableObject(e)?We((n=e,Array.isArray(n)?[]:{}),e,t):e;var n}function os(e,t,n){return e.concat(t).map(function(r){return Je(r,n)})}function Tn(e){return Object.keys(e).concat(function(t){return Object.getOwnPropertySymbols?Object.getOwnPropertySymbols(t).filter(function(n){return t.propertyIsEnumerable(n)}):[]}(e))}function Hn(e,t){try{return t in e}catch{return!1}}function as(e,t,n){var r={};return n.isMergeableObject(e)&&Tn(e).forEach(function(o){r[o]=Je(e[o],n)}),Tn(t).forEach(function(o){(function(a,i){return Hn(a,i)&&!(Object.hasOwnProperty.call(a,i)&&Object.propertyIsEnumerable.call(a,i))})(e,o)||(Hn(e,o)&&n.isMergeableObject(t[o])?r[o]=function(a,i){if(!i.customMerge)return We;var l=i.customMerge(a);return typeof l=="function"?l:We}(o,n)(e[o],t[o],n):r[o]=Je(t[o],n))}),r}function We(e,t,n){(n=n||{}).arrayMerge=n.arrayMerge||os,n.isMergeableObject=n.isMergeableObject||ns,n.cloneUnlessOtherwiseSpecified=Je;var r=Array.isArray(t);return r===Array.isArray(e)?r?n.arrayMerge(e,t,n):as(e,t,n):Je(t,n)}We.all=function(e,t){if(!Array.isArray(e))throw new Error("first argument should be an array");return e.reduce(function(n,r){return We(n,r,t)},{})};var ss=We;const Fn={text:{primary:"rgba(0, 0, 0, 0.87)",secondary:"rgba(0, 0, 0, 0.54)",disabled:"rgba(0, 0, 0, 0.38)"},background:{default:"#FFFFFF"},context:{background:"#e3f2fd",text:"rgba(0, 0, 0, 0.87)"},divider:{default:"rgba(0,0,0,.12)"},button:{default:"rgba(0,0,0,.54)",focus:"rgba(0,0,0,.12)",hover:"rgba(0,0,0,.12)",disabled:"rgba(0, 0, 0, .18)"},selected:{default:"#e3f2fd",text:"rgba(0, 0, 0, 0.87)"},highlightOnHover:{default:"#EEEEEE",text:"rgba(0, 0, 0, 0.87)"},striped:{default:"#FAFAFA",text:"rgba(0, 0, 0, 0.87)"}},Nn={default:Fn,light:Fn,dark:{text:{primary:"#FFFFFF",secondary:"rgba(255, 255, 255, 0.7)",disabled:"rgba(0,0,0,.12)"},background:{default:"#424242"},context:{background:"#E91E63",text:"#FFFFFF"},divider:{default:"rgba(81, 81, 81, 1)"},button:{default:"#FFFFFF",focus:"rgba(255, 255, 255, .54)",hover:"rgba(255, 255, 255, .12)",disabled:"rgba(255, 255, 255, .18)"},selected:{default:"rgba(0, 0, 0, .7)",text:"#FFFFFF"},highlightOnHover:{default:"rgba(0, 0, 0, .7)",text:"#FFFFFF"},striped:{default:"rgba(0, 0, 0, .87)",text:"#FFFFFF"}}};function is(e,t,n,r){const[o,a]=s.useState(()=>In(e)),[i,l]=s.useState(""),d=s.useRef("");$e(()=>{a(In(e))},[e]);const m=s.useCallback($=>{var R,g,u;const{attributes:S}=$.target,w=(R=S.getNamedItem("data-column-id"))===null||R===void 0?void 0:R.value;w&&(d.current=((u=(g=o[at(o,w)])===null||g===void 0?void 0:g.id)===null||u===void 0?void 0:u.toString())||"",l(d.current))},[o]),p=s.useCallback($=>{var R;const{attributes:g}=$.target,u=(R=g.getNamedItem("data-column-id"))===null||R===void 0?void 0:R.value;if(u&&d.current&&u!==d.current){const S=at(o,d.current),w=at(o,u),O=[...o];O[S]=o[w],O[w]=o[S],a(O),t(O)}},[t,o]),f=s.useCallback($=>{$.preventDefault()},[]),x=s.useCallback($=>{$.preventDefault()},[]),b=s.useCallback($=>{$.preventDefault(),d.current="",l("")},[]),y=function($=!1){return $?ve.ASC:ve.DESC}(r),E=s.useMemo(()=>o[at(o,n==null?void 0:n.toString())]||{},[n,o]);return{tableColumns:o,draggingColumnId:i,handleDragStart:m,handleDragEnter:p,handleDragOver:f,handleDragLeave:x,handleDragEnd:b,defaultSortDirection:y,defaultSortColumn:E}}var ls=s.memo(function(e){const{data:t=c.data,columns:n=c.columns,title:r=c.title,actions:o=c.actions,keyField:a=c.keyField,striped:i=c.striped,highlightOnHover:l=c.highlightOnHover,pointerOnHover:d=c.pointerOnHover,dense:m=c.dense,selectableRows:p=c.selectableRows,selectableRowsSingle:f=c.selectableRowsSingle,selectableRowsHighlight:x=c.selectableRowsHighlight,selectableRowsNoSelectAll:b=c.selectableRowsNoSelectAll,selectableRowsVisibleOnly:y=c.selectableRowsVisibleOnly,selectableRowSelected:E=c.selectableRowSelected,selectableRowDisabled:$=c.selectableRowDisabled,selectableRowsComponent:R=c.selectableRowsComponent,selectableRowsComponentProps:g=c.selectableRowsComponentProps,onRowExpandToggled:u=c.onRowExpandToggled,onSelectedRowsChange:S=c.onSelectedRowsChange,expandableIcon:w=c.expandableIcon,onChangeRowsPerPage:O=c.onChangeRowsPerPage,onChangePage:h=c.onChangePage,paginationServer:A=c.paginationServer,paginationServerOptions:U=c.paginationServerOptions,paginationTotalRows:M=c.paginationTotalRows,paginationDefaultPage:Z=c.paginationDefaultPage,paginationResetDefaultPage:ae=c.paginationResetDefaultPage,paginationPerPage:T=c.paginationPerPage,paginationRowsPerPageOptions:he=c.paginationRowsPerPageOptions,paginationIconLastPage:Ce=c.paginationIconLastPage,paginationIconFirstPage:se=c.paginationIconFirstPage,paginationIconNext:G=c.paginationIconNext,paginationIconPrevious:me=c.paginationIconPrevious,paginationComponent:de=c.paginationComponent,paginationComponentOptions:J=c.paginationComponentOptions,responsive:Ae=c.responsive,progressPending:q=c.progressPending,progressComponent:ue=c.progressComponent,persistTableHead:Y=c.persistTableHead,noDataComponent:pe=c.noDataComponent,disabled:K=c.disabled,noTableHead:te=c.noTableHead,noHeader:Se=c.noHeader,fixedHeader:ge=c.fixedHeader,fixedHeaderScrollHeight:X=c.fixedHeaderScrollHeight,pagination:be=c.pagination,subHeader:Re=c.subHeader,subHeaderAlign:Xe=c.subHeaderAlign,subHeaderWrap:et=c.subHeaderWrap,subHeaderComponent:Ct=c.subHeaderComponent,noContextMenu:St=c.noContextMenu,contextMessage:Rt=c.contextMessage,contextActions:H=c.contextActions,contextComponent:ur=c.contextComponent,expandableRows:tt=c.expandableRows,onRowClicked:Ut=c.onRowClicked,onRowDoubleClicked:qt=c.onRowDoubleClicked,onRowMouseEnter:Kt=c.onRowMouseEnter,onRowMouseLeave:Qt=c.onRowMouseLeave,sortIcon:pr=c.sortIcon,onSort:gr=c.onSort,sortFunction:Zt=c.sortFunction,sortServer:Et=c.sortServer,expandableRowsComponent:fr=c.expandableRowsComponent,expandableRowsComponentProps:hr=c.expandableRowsComponentProps,expandableRowDisabled:Jt=c.expandableRowDisabled,expandableRowsHideExpander:Xt=c.expandableRowsHideExpander,expandOnRowClicked:mr=c.expandOnRowClicked,expandOnRowDoubleClicked:br=c.expandOnRowDoubleClicked,expandableRowExpanded:en=c.expandableRowExpanded,expandableInheritConditionalStyles:wr=c.expandableInheritConditionalStyles,defaultSortFieldId:yr=c.defaultSortFieldId,defaultSortAsc:xr=c.defaultSortAsc,clearSelectedRows:tn=c.clearSelectedRows,conditionalRowStyles:vr=c.conditionalRowStyles,theme:nn=c.theme,customStyles:rn=c.customStyles,direction:Ye=c.direction,onColumnOrderChange:Cr=c.onColumnOrderChange,className:Sr}=e,{tableColumns:on,draggingColumnId:an,handleDragStart:sn,handleDragEnter:ln,handleDragOver:cn,handleDragLeave:dn,handleDragEnd:un,defaultSortDirection:Rr,defaultSortColumn:Er}=is(n,Cr,yr,xr),[{rowsPerPage:we,currentPage:ne,selectedRows:$t,allSelected:pn,selectedCount:gn,selectedColumn:ie,sortDirection:je,toggleOnSelectedRowsChange:$r},Ee]=s.useReducer(Jo,{allSelected:!1,selectedCount:0,selectedRows:[],selectedColumn:Er,toggleOnSelectedRowsChange:!1,sortDirection:Rr,currentPage:Z,rowsPerPage:T,selectedRowsFlag:!1,contextMessage:c.contextMessage}),{persistSelectedOnSort:fn=!1,persistSelectedOnPageChange:nt=!1}=U,hn=!(!A||!nt&&!fn),Or=be&&!q&&t.length>0,kr=de||ts,Pr=s.useMemo(()=>((C={},I="default",V="default")=>{const re=Nn[I]?I:V;return ss({table:{style:{color:(v=Nn[re]).text.primary,backgroundColor:v.background.default}},tableWrapper:{style:{display:"table"}},responsiveWrapper:{style:{}},header:{style:{fontSize:"22px",color:v.text.primary,backgroundColor:v.background.default,minHeight:"56px",paddingLeft:"16px",paddingRight:"8px"}},subHeader:{style:{backgroundColor:v.background.default,minHeight:"52px"}},head:{style:{color:v.text.primary,fontSize:"12px",fontWeight:500}},headRow:{style:{backgroundColor:v.background.default,minHeight:"52px",borderBottomWidth:"1px",borderBottomColor:v.divider.default,borderBottomStyle:"solid"},denseStyle:{minHeight:"32px"}},headCells:{style:{paddingLeft:"16px",paddingRight:"16px"},draggingStyle:{cursor:"move"}},contextMenu:{style:{backgroundColor:v.context.background,fontSize:"18px",fontWeight:400,color:v.context.text,paddingLeft:"16px",paddingRight:"8px",transform:"translate3d(0, -100%, 0)",transitionDuration:"125ms",transitionTimingFunction:"cubic-bezier(0, 0, 0.2, 1)",willChange:"transform"},activeStyle:{transform:"translate3d(0, 0, 0)"}},cells:{style:{paddingLeft:"16px",paddingRight:"16px",wordBreak:"break-word"},draggingStyle:{}},rows:{style:{fontSize:"13px",fontWeight:400,color:v.text.primary,backgroundColor:v.background.default,minHeight:"48px","&:not(:last-of-type)":{borderBottomStyle:"solid",borderBottomWidth:"1px",borderBottomColor:v.divider.default}},denseStyle:{minHeight:"32px"},selectedHighlightStyle:{"&:nth-of-type(n)":{color:v.selected.text,backgroundColor:v.selected.default,borderBottomColor:v.background.default}},highlightOnHoverStyle:{color:v.highlightOnHover.text,backgroundColor:v.highlightOnHover.default,transitionDuration:"0.15s",transitionProperty:"background-color",borderBottomColor:v.background.default,outlineStyle:"solid",outlineWidth:"1px",outlineColor:v.background.default},stripedStyle:{color:v.striped.text,backgroundColor:v.striped.default}},expanderRow:{style:{color:v.text.primary,backgroundColor:v.background.default}},expanderCell:{style:{flex:"0 0 48px"}},expanderButton:{style:{color:v.button.default,fill:v.button.default,backgroundColor:"transparent",borderRadius:"2px",transition:"0.25s",height:"100%",width:"100%","&:hover:enabled":{cursor:"pointer"},"&:disabled":{color:v.button.disabled},"&:hover:not(:disabled)":{cursor:"pointer",backgroundColor:v.button.hover},"&:focus":{outline:"none",backgroundColor:v.button.focus},svg:{margin:"auto"}}},pagination:{style:{color:v.text.secondary,fontSize:"13px",minHeight:"56px",backgroundColor:v.background.default,borderTopStyle:"solid",borderTopWidth:"1px",borderTopColor:v.divider.default},pageButtonsStyle:{borderRadius:"50%",height:"40px",width:"40px",padding:"8px",margin:"px",cursor:"pointer",transition:"0.4s",color:v.button.default,fill:v.button.default,backgroundColor:"transparent","&:disabled":{cursor:"unset",color:v.button.disabled,fill:v.button.disabled},"&:hover:not(:disabled)":{backgroundColor:v.button.hover},"&:focus":{outline:"none",backgroundColor:v.button.focus}}},noData:{style:{display:"flex",alignItems:"center",justifyContent:"center",color:v.text.primary,backgroundColor:v.background.default}},progress:{style:{display:"flex",alignItems:"center",justifyContent:"center",color:v.text.primary,backgroundColor:v.background.default}}},C);var v})(rn,nn),[rn,nn]),Dr=s.useMemo(()=>Object.assign({},Ye!=="auto"&&{dir:Ye}),[Ye]),W=s.useMemo(()=>{if(Et)return t;if(ie!=null&&ie.sortFunction&&typeof ie.sortFunction=="function"){const C=ie.sortFunction,I=je===ve.ASC?C:(V,re)=>-1*C(V,re);return[...t].sort(I)}return function(C,I,V,re){return I?re&&typeof re=="function"?re(C.slice(0),I,V):C.slice(0).sort((v,rt)=>{let ye,le;if(typeof I=="string"?(ye=Mt(v,I),le=Mt(rt,I)):(ye=I(v),le=I(rt)),V==="asc"){if(ye<le)return-1;if(ye>le)return 1}if(V==="desc"){if(ye>le)return-1;if(ye<le)return 1}return 0}):C}(t,ie==null?void 0:ie.selector,je,Zt)},[Et,ie,je,t,Zt]),Ve=s.useMemo(()=>{if(be&&!A){const C=ne*we,I=C-we;return W.slice(I,C)}return W},[ne,be,A,we,W]),Ir=s.useCallback(C=>{Ee(C)},[]),Ar=s.useCallback(C=>{Ee(C)},[]),jr=s.useCallback(C=>{Ee(C)},[]),_r=s.useCallback((C,I)=>Ut(C,I),[Ut]),Tr=s.useCallback((C,I)=>qt(C,I),[qt]),Hr=s.useCallback((C,I)=>Kt(C,I),[Kt]),Fr=s.useCallback((C,I)=>Qt(C,I),[Qt]),_e=s.useCallback(C=>Ee({type:"CHANGE_PAGE",page:C,paginationServer:A,visibleOnly:y,persistSelectedOnPageChange:nt}),[A,nt,y]),Nr=s.useCallback(C=>{const I=Ke(M||Ve.length,C),V=At(ne,I);A||_e(V),Ee({type:"CHANGE_ROWS_PER_PAGE",page:V,rowsPerPage:C})},[ne,_e,A,M,Ve.length]);if(be&&!A&&W.length>0&&Ve.length===0){const C=Ke(W.length,we),I=At(ne,C);_e(I)}$e(()=>{S({allSelected:pn,selectedCount:gn,selectedRows:$t.slice(0)})},[$r]),$e(()=>{gr(ie,je,W.slice(0))},[ie,je]),$e(()=>{h(ne,M||W.length)},[ne]),$e(()=>{O(we,ne)},[we]),$e(()=>{_e(Z)},[Z,ae]),$e(()=>{if(be&&A&&M>0){const C=Ke(M,we),I=At(ne,C);ne!==I&&_e(I)}},[M]),s.useEffect(()=>{Ee({type:"CLEAR_SELECTED_ROWS",selectedRowsFlag:tn})},[f,tn]),s.useEffect(()=>{if(!E)return;const C=W.filter(V=>E(V)),I=f?C.slice(0,1):C;Ee({type:"SELECT_MULTIPLE_ROWS",keyField:a,selectedRows:I,totalRows:W.length,mergeSelections:hn})},[t,E]);const Lr=y?Ve:W,Mr=nt||f||b;return s.createElement(qo,{theme:Pr},!Se&&(!!r||!!o)&&s.createElement(Fa,{title:r,actions:o,showMenu:!St,selectedCount:gn,direction:Ye,contextActions:H,contextComponent:ur,contextMessage:Rt}),Re&&s.createElement(Ma,{align:Xe,wrapContent:et},Ct),s.createElement(Wa,Object.assign({responsive:Ae,fixedHeader:ge,fixedHeaderScrollHeight:X,className:Sr},Dr),s.createElement(Ba,null,q&&!Y&&s.createElement(_n,null,ue),s.createElement(ea,{disabled:K,className:"rdt_Table",role:"table"},!te&&(!!Y||W.length>0&&!q)&&s.createElement(na,{className:"rdt_TableHead",role:"rowgroup",fixedHeader:ge},s.createElement(ra,{className:"rdt_TableHeadRow",role:"row",dense:m},p&&(Mr?s.createElement(Ge,{style:{flex:"0 0 48px"}}):s.createElement(Da,{allSelected:pn,selectedRows:$t,selectableRowsComponent:R,selectableRowsComponentProps:g,selectableRowDisabled:$,rowData:Lr,keyField:a,mergeSelections:hn,onSelectAllRows:Ar})),tt&&!Xt&&s.createElement(Ga,null),on.map(C=>s.createElement(ka,{key:C.id,column:C,selectedColumn:ie,disabled:q||W.length===0,pagination:be,paginationServer:A,persistSelectedOnSort:fn,selectableRowsVisibleOnly:y,sortDirection:je,sortIcon:pr,sortServer:Et,onSort:Ir,onDragStart:sn,onDragOver:cn,onDragEnd:un,onDragEnter:ln,onDragLeave:dn,draggingColumnId:an})))),!W.length&&!q&&s.createElement(Ya,null,pe),q&&Y&&s.createElement(_n,null,ue),!q&&W.length>0&&s.createElement(za,{className:"rdt_TableBody",role:"rowgroup"},Ve.map((C,I)=>{const V=ze(C,a),re=function(le=""){return typeof le!="number"&&(!le||le.length===0)}(V)?I:V,v=ut(C,$t,a),rt=!!(tt&&en&&en(C)),ye=!!(tt&&Jt&&Jt(C));return s.createElement(va,{id:re,key:re,keyField:a,"data-row-id":re,columns:on,row:C,rowCount:W.length,rowIndex:I,selectableRows:p,expandableRows:tt,expandableIcon:w,highlightOnHover:l,pointerOnHover:d,dense:m,expandOnRowClicked:mr,expandOnRowDoubleClicked:br,expandableRowsComponent:fr,expandableRowsComponentProps:hr,expandableRowsHideExpander:Xt,defaultExpanderDisabled:ye,defaultExpanded:rt,expandableInheritConditionalStyles:wr,conditionalRowStyles:vr,selected:v,selectableRowsHighlight:x,selectableRowsComponent:R,selectableRowsComponentProps:g,selectableRowDisabled:$,selectableRowsSingle:f,striped:i,onRowExpandToggled:u,onRowClicked:_r,onRowDoubleClicked:Tr,onRowMouseEnter:Hr,onRowMouseLeave:Fr,onSelectedRow:jr,draggingColumnId:an,onDragStart:sn,onDragOver:cn,onDragEnd:un,onDragEnter:ln,onDragLeave:dn})}))))),Or&&s.createElement("div",null,s.createElement(kr,{onChangePage:_e,onChangeRowsPerPage:Nr,rowCount:M||W.length,currentPage:ne,rowsPerPage:we,direction:Ye,paginationRowsPerPageOptions:he,paginationIconLastPage:Ce,paginationIconFirstPage:se,paginationIconNext:G,paginationIconPrevious:me,paginationComponentOptions:J})))});const us=()=>{const{i18n:e}=Wr(),t=localStorage.getItem("sellerLogged"),n=JSON.parse(localStorage.getItem("sellerToken")),r=Br();if(!t)return r("/seller-login"),null;const{mainRequest:o}=s.useContext(Gr),[a,i]=s.useState([]),[l,d]=s.useState(!1),[m,p]=s.useState([]);console.log(a);const f=async()=>{d(!0);try{const g=await o.post(`${Vr}/vendor/order`,{token:n});i(g.data.data)}catch(g){console.log(g)}finally{d(!1)}};s.useEffect(()=>{f()},[n,t]);const x=g=>{const u=parseInt(g),w=(h=>{switch(h){case 0:return e.language==="en"?"Prepared":"قيد التحضير";case 1:return e.language==="en"?"Prepared":"قيد التحضير";case 2:return e.language==="en"?"At the Store":"قيد التخزين";case 3:return e.language==="en"?"At the Delivery Stage":"قيد مرحلة التوصيل";case 4:return e.language==="en"?"Delivered":"تم التوصيل";default:return""}})(u),O=u===0||u===1?"blue":u===2?"green":u===3?"purple":u===4?"teal":"black";return Q.jsx("span",{style:{backgroundColor:O},className:"text-white p-2 rounded-xl shadow-lg",children:w})},b=g=>{const u=new Date(g);return u.setDate(u.getDate()+20),u.toISOString().split("T")[0]},y=[{name:"Order ID",selector:"id",sortable:!0},{name:"Product ID",selector:"product_id",sortable:!0},{name:"Product Name",selector:"product.title.en",sortable:!0},{name:"Product Price",selector:"product.price",sortable:!0},{name:"Quantity",selector:"quantity",sortable:!0},{name:"Total Price",selector:"total_price",sortable:!0},{name:"Date",selector:"order.date",sortable:!0},{name:"Due Date",selector:"order.date",sortable:!0,cell:g=>b(g.order.date)},{name:"Status",selector:"order?.status",sortable:!0,cell:g=>{var u;return x((u=g.order)==null?void 0:u.status)}}],E=[{name:"رقم الطلب",selector:"id",sortable:!0},{name:"رقم المنتج",selector:"product_id",sortable:!0},{name:"اسم المنتج",selector:"product.title.ar",sortable:!0},{name:"سعر المنتج",selector:"product.price",sortable:!0},{name:"الكمية",selector:"quantity",sortable:!0},{name:"السعر الكلي",selector:"total_price",sortable:!0},{name:"التاريخ",selector:"order.date",sortable:!0},{name:"تاريخ الأستحقاق",selector:"order.date",sortable:!0,cell:g=>b(g.order.date)},{name:"الحالة",selector:"order?.status",sortable:!0,cell:g=>{var u;return x((u=g.order)==null?void 0:u.status)}}],$=e.language==="en"?y:E,R=g=>{const u=g.target.value.toLowerCase();if(u.trim()==="")p(a);else{const S=a.filter(w=>{var O,h,A,U,M;return((O=w==null?void 0:w.id)==null?void 0:O.toString().toLowerCase().includes(u))||((h=w==null?void 0:w.product_id)==null?void 0:h.toString().toLowerCase().includes(u))||((A=w==null?void 0:w.product.title.en)==null?void 0:A.toString().toLowerCase().includes(u))||((U=w==null?void 0:w.product.title.ar)==null?void 0:U.toString().toLowerCase().includes(u))||((M=w==null?void 0:w.user_id)==null?void 0:M.toString().toLowerCase().includes(u))});console.log(S),p(S)}};return l?Q.jsx(Yr,{}):Q.jsx("div",{className:"container py-10 min-h-[40dvh]",children:(a==null?void 0:a.length)>0?Q.jsxs("div",{children:[Q.jsx("div",{className:"mb-10 flex flex-col items-start gap-2 sm:flex-row sm:items-center justify-between",children:Q.jsx(mn,{})}),Q.jsx("input",{type:"text",placeholder:"Search by Order ID, Product ID or Product Title ...",onChange:R,className:"px-4 py-2 w-full mb-2 border rounded-md focus:outline-none focus:ring focus:ring-blue-200"}),Q.jsx(ls,{columns:$,data:m,className:"order-table"})]}):Q.jsxs(Q.Fragment,{children:[Q.jsx(mn,{}),Q.jsx("div",{className:"flex flex-col items-center justify-center",children:Q.jsx("h1",{className:"text-2xl font-bold text-red-600",children:e.language==="en"?"You Don't Have Any Orders Yet!":"ليس لديك اي طلبات بعد"})})]})})};export{us as default};
